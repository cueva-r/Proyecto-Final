...
<html>
    ...
    <body>
        ...
        <div class="form-container container border border-info-subtle border-5 rounded-5" style="font-size:35px">
            <form action="registroAdopcion.jsp" class="row g-3" method="post">
                <div class="form1 container">
                    ...
                    <div class="col-12">
                        <label for="inputAddress" class="form-label">Trabajo</label>
                        <input type="text" class="form-control" name="txttrab" placeholder="Ej. Contador" style="font-size:30px">
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="txtest" placeholder="Soltero o Casado" style="font-size:30px">
                    </div>
                    <div class="col-12">
                        <label for="inputCity" class="form-label">Ciudad de Procedencia</label>
                        <input type="text" class="form-control" name="txtnac" placeholder="Ej. Lima" style="font-size:30px">
                    </div>
                    <div class="col-12">
                ...
                <div class="form2 container">
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">¿Ha tenido mascotas antes?</label>
                        <input type="text" class="form-control" name="txtpre1" placeholder="SI o NO" style="font-size:30px">
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">¿Tiene mascotas actualmente?</label>
                        <input type="text" class="form-control" name="txtpre2" placeholder="SI o NO" style="font-size:30px">
                    </div>
                    <div class="col-12">
                        <label for="comment">¿Por qué desea adoptar una mascota?</label>
                        <textarea class="form-control" rows="3" name="txtpre3" style="font-size:30px"></textarea>
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">¿Tiene la solvencia económica para criar una mascota?</label>
                        <input type="text" class="form-control" name="txtpre4" placeholder="SI o NO" style="font-size:30px">
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">¿Tiene el espacio adecuado para criar una mascota?</label>
                        <input type="text" class="form-control" name="txtpre5" placeholder="SI o NO" style="font-size:30px">
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">Código de la mascota interesada en adoptar: </label>
                        <input type="text" class="form-control" name="txtid" placeholder="Ej. 1 ó 2 ó 3 " style="font-size:30px">
                    </div>
                    <br>
                    <p><input type="submit" name="btnRegistrar" class="btn btn-primary" style="font-size:35px" value="Registrar"></p>
                </div>
        ...
        <%
            ...
            if (request.getParameter("btnRegistrar") != null) {
                try {//Guardar los datos en  la base de datos
                    ...
                    PreparedStatement pst = conexion.prepareStatement("insert into registro_adoptante values(null,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                    ...
                    pst.setString(5, request.getParameter("txttrab"));
                    pst.setInt(6, Integer.parseInt(request.getParameter("txtcel")));
                    pst.setString(7, request.getParameter("txtest"));
                    pst.setString(8, request.getParameter("txtnac"));
                    pst.setString(9, request.getParameter("txtdir"));
                    pst.setString(10, request.getParameter("txtcorr"));
                    pst.setString(11, request.getParameter("txtpre1"));
                    pst.setString(12, request.getParameter("txtpre2"));
                    pst.setString(13, request.getParameter("txtpre3"));
                    pst.setString(14, request.getParameter("txtpre4"));
                    pst.setString(15, request.getParameter("txtpre5"));
                    pst.setInt(16, Integer.parseInt(request.getParameter("txtid")));

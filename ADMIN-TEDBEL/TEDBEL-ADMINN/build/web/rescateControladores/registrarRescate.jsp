    ...
    <div class="container">
        ...
        <div class="info">
         ...
         <div class="container p-2  bg-dark text-white">
                    <h1>Registrar Rescate</h1>
                    
                        <form>
                            <div class="row">
                              <div class="col">
                                  Ingresar El ID del Rescatista
                                <input type="text" class="form-control"  name="idRes">
                              </div>
                              <div class="col">
                                  Ingresar el ID del animal 
                                <input type="text" class="form-control"  name="idAni">
                              </div>
                            </div>
                            
                            <div class="row">
                              <div class="col">
                                  Ingresar la Fecha del Rescate
                                <input type="date" class="form-control"  name="fecha">
                              </div>
                              <div class="col">
                                  Ingresar el Estado del Animal 
                            ...
                            <div class="row">
                              <div class="col">
                                  Ingresar el Peso del Animal
                                <input type="text" class="form-control"  name="peso">
                              </div>
                              <div class="col">
                                  Ingresar el Lugar a Rescatar
                            ...
                            <div class="row">
                              <div class="col">
                                  Ingresar Descripcion del Rescate 
   ...
   <%
            ...
            if (request.getParameter("btnRegistrar")!=null){
                  try {//Guardar los datos en  la base de datos
                        ...
                        PreparedStatement  pst  = conexion.prepareStatement("insert into registro_rescate values(null,?,?,?,?,?,?,?)");
                        //3.1. //Establecer los valores en los parametros "?"
                            pst.setInt(1, Integer.parseInt(request.getParameter("idRes")));
                            pst.setInt(2, Integer.parseInt(request.getParameter("idAni")));
                            pst.setDate(3, Date.valueOf(request.getParameter("fecha")));
                            pst.setString(4, request.getParameter("estado"));                            
                            pst.setFloat(5, Float.parseFloat(request.getParameter("peso")));
                            pst.setString(6, request.getParameter("lugar"));
                            pst.setString(7, request.getParameter("descripcion"));
                        //4. Ejecutar en la base de datos
                        pst.executeUpdate();
                         //5. Liberar los recursos
                         conexion.close();
                         //6. Abrir la pagina 
                         response.sendRedirect("../vistas/rescate.jsp");
                      } catch (Exception e) {
                          out.print(e);
                    }
            }

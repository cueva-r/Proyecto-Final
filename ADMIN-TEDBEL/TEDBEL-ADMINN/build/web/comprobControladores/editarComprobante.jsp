    ...
    <div class="container">
        ...
        <div class="info">
            ...
            try {//EVALUA SI HAY ERROR
                    ...
                    //CREAR INSTRUCCION DE CONSULTA "SELECT"
                    PreparedStatement pst =conexion.prepareStatement("select * from detalle_comprobante where id=?");
                    //AGREGAR DATO DEL CODIGO EN EL PARAMETRO DE ENTRADA
                        pst.setInt(1,Integer.parseInt(request.getParameter("idDetalle")));
                        //EJECUTAR Y RETORANAR LA INFORMACION
                        ResultSet tabla = pst.executeQuery();
                        //Leer los datos
                        tabla.next();
                        //  MOSTRAR EL PANTALLA
                            out.print("<form class='text-center' action='./actualizarComprobante.jsp' method='post'>");
                                
                                out.print("<p><input type='text' name='id' value="+tabla.getInt(1)+">");
                                out.print("<p><input type='text' name='ruc' value="+tabla.getInt(2)+">");
                                out.print("<p><input type='text' name='direccion' value="+tabla.getString(3)+">");
                                out.print("<p><input type='text' name='fecha' value="+tabla.getDate(4)+">");
                                out.print("<p><input type='text' name='nombre' value="+tabla.getString(5)+">");
                                out.print("<p><input type='text' name='servicios' value="+tabla.getString(6)+">");
                                out.print("<p><input type='text' name='articulos' value="+tabla.getString(7)+">");
                                out.print("<p><input type='text' name='total' value="+tabla.getDouble(8)+">");

...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="info">
            ...
            <div class="row mt-3">
                <div class="col">
                    <a href="../vistas/servicios.jsp" class="btn btn-danger">Atras</a>
                </div>
            </div>
            ...
            try {//EVALUA SI HAY ERROR
                    ...
                    PreparedStatement pst =conexion.prepareStatement("select * from servicio where id=?");
                    //AGREGAR DATO DEL CODIGO EN EL PARAMETRO DE ENTRADA
                        pst.setInt(1,Integer.parseInt(request.getParameter("idServicio")));
                        //EJECUTAR Y RETORANAR LA INFORMACION
                        ResultSet tabla = pst.executeQuery();
                        //Leer los datos
                        tabla.next();
                        //  MOSTRAR EL PANTALLA
                            out.print("<form class='text-center' action='./actualizarServicios.jsp' method='post'>");
                                
                                out.print("<p><input type='text' name='VERID' value="+tabla.getInt(1)+">");
                                out.print("<p><input type='text' name='VERprecio' value="+tabla.getDouble(2)+">");
                                out.print("<p><input type='text' name='VERnombre' value="+tabla.getString(3)+">");
                                out.print("<p><input type='text' name='VERidMascota' value="+tabla.getInt(4)+">");
                                out.print("<p><input type='text' name='VERid_cliente' value="+tabla.getInt(5)+">");

...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="info">
            ...
            <div class="row mt-3">
                <div class="col">
                    <a href="../articulosControladores/registrarArticulo.jsp" class="btn btn-dark">Registrar Articulo</a>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col">
                    ...
                    try {
                        ...
                        out.print("<tr>");
                        out.print("<th>ID Producto <th>Nombre <th>ID Categoria <th colspan=3>Operaciones");

                            while (tabla.next()) { // leer los datos
                          out.print("<tr>");
                          out.print("<td>" + tabla.getInt("id_producto") + "</td>");
                          out.print("<td>" + tabla.getString("nombre") + "</td>");
                          out.print("<td>" + tabla.getInt("id_categoria") + "</td>");
                          

                          out.print("<td><a href=\"../articulosControladores/verArticulo.jsp?id="+tabla.getObject("id_producto")+"\" class='btn btn-danger'> Ver </a>");
                          out.print("<td><a href=\"../articulosControladores/editarArticulo.jsp?id="+tabla.getObject("id_producto")+"\" class='btn btn-primary'> Editar </a>");
                          out.print("<td><a href=\"../articulosControladores/eliminarArticulo.jsp?id="+tabla.getObject("id_producto")+"\" class='btn btn-secondary'> Eliminar </a>");
                          out.print("</tr>");
                      }
                      conexion.close(); 
                  } catch (Exception e) { 

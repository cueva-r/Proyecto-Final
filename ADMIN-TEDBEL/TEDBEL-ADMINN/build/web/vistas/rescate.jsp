...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="info">
            ...
            <div class="row mt-3">
                <div class="col-6">
                    <a href="../rescateControladores/registrarRescate.jsp" class="btn btn-dark">Registrar Rescate</a>
                    <a href="../vistas/rescatesSolicitados.jsp" class="btn btn-dark">Rescates Solicitados</a>
                </div>
            ...
            <div class="row mt-3">
                <div class="col">
                    <%
                        try {//Traer a la información de la tabla
                            //1. Conexion a la base de datos
                            Connection conexion = ConexionMysql.retornaConexion();
                            //2. Preparar la consulta
                            PreparedStatement  pst  = conexion.prepareStatement("select * from registro_rescate");
                            //3. Ejecutar y almacenar en una tabla virtual(RAM)
                            ResultSet tabla = pst.executeQuery();
                            //4. Preparar la tabla de HML
                            out.print("<table class='table table-striped'>");
                            out.print("<tr>");
                            out.print("<th>id <th>idRescatista <th>idAnimal <th>Fecha <th>Estado <th>Peso <th>Lugar <th>Descripción <th colspan=3>Operaciones");
                            //5. Mostrar los datos en la Web
                            while(tabla.next()){
                                out.print("<tr>");
                                out.print("<td>"+tabla.getObject("id"));
                                out.print("<td>"+tabla.getObject("idRescatista"));
                                out.print("<td>"+tabla.getObject("idAnimal"));
                                out.print("<td>"+tabla.getObject("fecha"));
                                out.print("<td>"+tabla.getObject("estado"));
                                out.print("<td>"+tabla.getObject("peso"));
                                out.print("<td>"+tabla.getObject("lugar"));
                                out.print("<td>"+tabla.getObject("descripcion"));
                                out.print("<td><a href=\"../rescateControladores/verRescate.jsp?idRescate="+tabla.getObject("id")+"\" class='btn btn-primary'> Ver </a>");
                                out.print("<td><a href=\"../rescateControladores/editarRescate.jsp?idRescate="+tabla.getObject("id")+"\" class='btn btn-secondary'> Editar </a>");
                                out.print("<td><a href=\"../rescateControladores/eliminarRescate.jsp?idRescate="+tabla.getObject("id")+"\" class='btn btn-danger'> Eliminar </a>");
                            }

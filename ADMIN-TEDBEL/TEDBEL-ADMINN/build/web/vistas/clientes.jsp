                ...
                <div class="col">
                    ...
                    <%
                        try {
                            ...
                            out.print("<tr>");
                            out.print("<th>Codigo <th>Nombre <th>Apellido <th colspan=3>Operaciones");

                                while (tabla.next()) { // leer los datos
                              out.print("<tr>");
                              out.print("<td>" + tabla.getInt("id") + "</td>");
                              out.print("<td>" + tabla.getString("nombre") + "</td>");
                              out.print("<td>" + tabla.getString("apellido") + "</td>");
                              

                              out.print("<td><a href=\"../clienteControladores/verCliente.jsp?idCliente="+tabla.getObject("id")+"\" class='btn btn-danger'> Ver </a>");
                              out.print("<td><a href=\"../clienteControladores/editarCliente.jsp?idCliente="+tabla.getObject("id")+"\" class='btn btn-primary'> Editar </a>");
                              out.print("<td><a href=\"../clienteControladores/eliminarCliente.jsp?idCliente="+tabla.getObject("id")+"\" class='btn btn-secondary'> Eliminar </a>");
                              out.print("</tr>");
                          }
                          conexion.close(); 
                      } catch (Exception e) { 

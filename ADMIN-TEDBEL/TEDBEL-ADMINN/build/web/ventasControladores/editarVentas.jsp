...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="info">
            ...
            <div class="row mt-3">
                <div class="col">
                    <a href="../vistas/ventas.jsp" class="btn btn-danger">Atras</a>
                </div>
            </div>
                ...
                <%
                        try {//Evalua si hay error
                            ...
                            PreparedStatement pst = conexion.prepareStatement("select * from venta where id=?");
                            ...
                            tabla.next();
                            //5. Mostrar en la web
                            out.print("<form class='text-center' action='actualizarVentas.jsp' method='post'>");
                                out.print("<p><input type='text' name='ID' value="+tabla.getInt(1)+">");
                                out.print("<p><input type='text' name='idCliente' value="+tabla.getInt(2)+">");
                                out.print("<p><input type='text' name='id_productos' value="+tabla.getInt(3)+">");
                                out.print("<p><input type='text' name='fechaa' value="+tabla.getDate(4)+">");

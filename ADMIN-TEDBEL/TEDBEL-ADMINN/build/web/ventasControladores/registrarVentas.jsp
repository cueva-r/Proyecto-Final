   ...
   <%
            ...
            if (request.getParameter("btnRegistrar")!=null){
                  try {//Guardar los datos en  la base de datos
                        ...
                        PreparedStatement  pst  = conexion.prepareStatement("insert into venta values(null,?,?,?)");
                        //3.1. //Establecer los valores en los parametros "?"
                            pst.setInt(1, Integer.parseInt(request.getParameter("Cliente")));
                            pst.setInt(2, Integer.parseInt(request.getParameter("Articulo")));

  ...
  <tbody>
    ...
    <%
            try {
                    ...
                    PreparedStatement pst = conexion.prepareStatement("update venta set id_cliente=? , id_productos=?, fecha=? where id=? ");
                       //3.1.  Agregar los  parametros
                       pst.setInt(1,Integer.parseInt(request.getParameter("idCliente")));
                       pst.setInt(2,Integer.parseInt(request.getParameter("id_productos")));
                       pst.setDate(3, Date.valueOf(request.getParameter("fechaa")));

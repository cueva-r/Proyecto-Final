    ...
    <div class="container">
        ...
        <div class="info">
            ...
            try {//CONTROLAR ERRORES
                //1 CARGAR EL DRIVER Y CONEXION ALA BASE DE DATOS
                Connection conexion = ConexionMysql.retornaConexion();
                //PREPARAR LA INSTRICCION SQL "ELIMINAR"
                 PreparedStatement pst = conexion.prepareStatement("delete from servicio where id=?");
                 //AGREGAR UN PARAMETRO EN LA CONSULTA
                        ...
                        conexion.close();
                        //MENSAJEEEEEE
                        out.print("<h2>Servicio eliminado</h2>");

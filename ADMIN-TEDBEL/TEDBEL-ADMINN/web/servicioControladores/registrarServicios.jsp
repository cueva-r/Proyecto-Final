                ...
                <div class="container p-2  bg-dark text-white">
                    <h1>Registrar Servicios</h1>
                        ...
                        <form>
                            <div class="row">
                              <div class="col">
                                  Ingresar Precio del Servicio
                                <input type="text" class="form-control"  name="txtPrecio">
                              </div>
                              <div class="col">
                                  Ingresar Nombre del Servicio 
                                <input type="text" class="form-control"  name="txtNombreSer">
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col">
                                ...
                                <input type="text" class="form-control"  name="txtmascota">
                              </div>
                              <div class="col">
                            ...
                            <div class="row">
                              ...
                              <div class="col">
                                  ...
                                  <a href="../vistas/servicios.jsp" class="btn btn-danger">Cancelar</a>
                                  </p>
            ...
            <%
                        ...
                        if (request.getParameter("btnRegistrar")!=null){
                          try{
                              ...
                              PreparedStatement pst = conexion.prepareStatement("insert into servicio values(null,?,?,?,?)");


                                  pst.setDouble(1,Double.parseDouble(request.getParameter("txtPrecio")));
                                  pst.setString(2,request.getParameter("txtNombreSer"));
                                  pst.setInt(3,Integer.parseInt(request.getParameter("txtmascota")));
                                  pst.setInt(4,Integer.parseInt(request.getParameter("txtcliente")));

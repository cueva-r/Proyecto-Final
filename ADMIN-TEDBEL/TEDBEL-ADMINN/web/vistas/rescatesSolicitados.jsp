                ...
                <div class="col">
                    <%
                        try {//Traer a la información de la tabla
                            ...
                            PreparedStatement  pst  = conexion.prepareStatement("select * from solicitar_rescate");
                            //3. Ejecutar y almacenar en una tabla virtual(RAM)
                            ResultSet tabla = pst.executeQuery();
                            //4. Preparar la tabla de HML
                            out.print("<table class='table table-striped'>");
                            out.print("<tr>");
                            out.print("<th>ID <th>DNI del Solitante <th>Apellido <th>Nombres <th>Edad <th>Estado <th>Animal <th>Celular <th>Direccion <th>Correo");
                            ...
                            while(tabla.next()){
                                ...
                                out.print("<td>"+tabla.getObject("nombres"));
                                out.print("<td>"+tabla.getObject("edad"));
                                out.print("<td>"+tabla.getObject("estado"));
                                out.print("<td>"+tabla.getObject("animal"));
                                out.print("<td>"+tabla.getObject("celular"));
                                out.print("<td>"+tabla.getObject("direccion"));
                                out.print("<td>"+tabla.getObject("correo"));
                            }

  ...
  <tbody>
    ...
    <%
            try {
                    ...
                    PreparedStatement pst = conexion.prepareStatement("update registro_rescate set idRescatista=? , idAnimal=?, fecha=?, estado=?, peso=?, lugar=?, descripcion=? where id=? ");
                       //3.1.  Agregar los  parametros
                       pst.setInt(1,Integer.parseInt(request.getParameter("idRescatista")));
                       pst.setInt(2,Integer.parseInt(request.getParameter("idAnimal")));
